...
const defaultResultPaths = [
  path.join(
    ...
    "vivado_xsim",
    "sessions",
    "260727_return_feasibility_boundary1_r1_w32_system_integration_smoke",
    "rtl_result.json"
  ),
  path.join(
    hdlRoot,
    ...
    "vivado_xsim",
    "sessions",
    "260727_return_feasibility_boundary1_r7_w32_system_integration_smoke",
    "rtl_result.json"
  ),
  path.join(
    hdlRoot,
    ...
    "vivado_xsim",
    "sessions",
    "260727_return_feasibility_boundary1_r7_w64_system_integration_smoke",
    "rtl_result.json"
  ),
  path.join(
    hdlRoot,
    ...
    "vivado_xsim",
    "sessions",
    "260727_return_feasibility_boundary1_r7_w128_system_integration_smoke",
    "rtl_result.json"
  )
];
...
const selfTests = {
  ...
  returns: sandbox.__C08_RETURN_FEASIBILITY_SELF_TEST__,
