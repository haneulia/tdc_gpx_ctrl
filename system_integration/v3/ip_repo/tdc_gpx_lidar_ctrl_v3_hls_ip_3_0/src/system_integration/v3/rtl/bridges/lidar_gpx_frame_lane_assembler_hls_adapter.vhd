...
-- V3 HLS Cell-to-Frame ê²½ê³„ Adapter.
-- HLSê°€ ë§Œë“  Rise/Fall Cell?„ ?…ë¦¨ö FIFO?— ??€?ž¥?•˜?—¬ ?•œ Lane?˜ Backpressureê°€
-- ?‹¤ë¥¢¬ Lane?„ ë©ˆì¶”ì§€ ?•Šê²? ?•œ?‹¤. shot_done??€ ê³„ì‚° ?™„ë£Œê¡Æ€ ?•„?‹ˆ?¼ ?•„?š”?•œ ëª¨ë“ 
-- Lane?˜ line_endê°€ ?‹¤? œ ?†Œë¹„ëœ ?’¤?—ë§? ë°œìƒ?•œ?‹¤.
...
begin
    ...
    -- H2 Cell/Face-close ê³„ì•½?„ H3 HLS ?ž…? ¥ê¹Œì¡×€ ?•œ Cycle?— ì§ì ‘ ?—°ê²°í•˜ì§€
    -- ?•Š?Š”?‹¤. ì²˜ë¦¬?œ¨?„ ?œ ì§€?•˜?Š” Registered skidê°€ ?­?´ ?° Record?˜
    -- Placement ê²½ê³„ë¥¨ù ë§Œë“¤ê³? abort ?‹œ ??€ê¸¡Æ Event?„ ?•¨ê»? ?ê¸°í•œ?‹¤.
    ...
    -- abort stale-output Drain ?ƒ?ƒœê°€ H2 Readyê¹Œì¡×€ ?•œ Cycle ì¡°í•© ê²½ë¡œë¡?
    -- ?—­? „?ŒŒ?˜ì§€ ?•Š?„ë¡? ?ž…? ¥ ?—ˆ?š© ì°½ì„ Register?•œ?‹¤.
    ...
    u_hls_frame_assembler : h3_assembler_ip
        port map (
            ap_clk   => i_clk,
            ap_rst_n => i_rst_n,
            ap_start => '1',
