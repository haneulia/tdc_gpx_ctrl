...
entity gpx_frame_assembler_hls_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity gpx_frame_assembler_hls_regslice_both;

architecture behave of gpx_frame_assembler_hls_regslice_both is
