...
entity gpx_lane_word_formatter_hls_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity gpx_lane_word_formatter_hls_regslice_both;

architecture behave of gpx_lane_word_formatter_hls_regslice_both is
