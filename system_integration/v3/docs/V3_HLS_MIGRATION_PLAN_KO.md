...
2. 물리 IFIFO는 Runtime 전시 Return 수와 무관하게 EF 완료까지 Drain한다.
...
| H2 | 다음 | Hit-to-Cell | Return 1~7, filter, overflow, timeout PASS |
| H3 | 대기 | Cell-to-Frame | 1-Chip dual-edge, 4-Chip all-dual, dedicated PASS |
...
- 핵심 스트림 loop의 initiation interval은 1이다.
