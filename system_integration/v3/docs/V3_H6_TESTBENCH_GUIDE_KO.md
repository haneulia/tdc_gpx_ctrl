...
Runtime VDMA/DDR/PS는 H6-B2가 소유한다.
...
| `tb_tdc_gpx_lidar_ctrl_v3_h6b.vhd` | V2 제어 계층과 V3 HLS 데이터 경로를 실제 통합 Top에서 결합 | 4 Chip Reg7 Shadow/Active/Physical, COMMIT 실패 복구, IFIFO Drain, AXI/Footer stall, 0x27 CSR routing |
