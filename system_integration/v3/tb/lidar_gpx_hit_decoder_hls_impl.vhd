...
-- Out-of-context implementation harness for the V3 HLS GPX Hit decoder.
-- The ports intentionally match the V2 implementation harness so timing and
-- resource results can be compared without changing the logical boundary.
entity lidar_gpx_hit_decoder_hls_impl is
    generic (
...
end entity lidar_gpx_hit_decoder_hls_impl;

architecture rtl of lidar_gpx_hit_decoder_hls_impl is
...
begin
    ...
    u_decoder : entity work.lidar_gpx_hit_decoder_hls_adapter
        generic map (
