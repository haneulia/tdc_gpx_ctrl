# TDC-GPX LiDAR V2 Stage-L0 timing/CDC contract.
#
# Clock domains:
#   clk_fpga_0                                      = CSR/AXI-Lite 100 MHz
#   clk_out1_design_1_lidar_ctrl_v2_proc_clk_wiz_0 = Processing 150 MHz
...
set l0_v2_meta_d [get_pins -quiet -hier -regexp \
    {^.*/tdc_gpx_lidar_ctrl_v2_0/U0/.*_meta_r_reg.*\/D$}]
set_false_path -to $l0_v2_meta_d
...
set l0_proc_diag_req_src [get_cells -quiet -hier -regexp \
    {^.*/tdc_gpx_lidar_ctrl_v2_0/U0/u_status_snapshot/u_proc_mailbox/request_payload_r_reg.*$}]
set l0_proc_diag_req_dst [get_cells -quiet -hier -regexp \
    {^.*/tdc_gpx_lidar_ctrl_v2_0/U0/u_status_snapshot/u_proc_mailbox/domain_request_r_reg.*$}]
set l0_proc_diag_rsp_src [get_cells -quiet -hier -regexp \
    {^.*/tdc_gpx_lidar_ctrl_v2_0/U0/u_status_snapshot/u_proc_mailbox/domain_response_r_reg.*$}]
set l0_proc_diag_rsp_dst [get_cells -quiet -hier -regexp \
    {^.*/tdc_gpx_lidar_ctrl_v2_0/U0/u_status_snapshot/u_proc_mailbox/source_response_r_reg.*$}]
set l0_tdc_diag_req_src [get_cells -quiet -hier -regexp \
    {^.*/tdc_gpx_lidar_ctrl_v2_0/U0/u_status_snapshot/u_tdc_mailbox/request_payload_r_reg.*$}]
set l0_tdc_diag_req_dst [get_cells -quiet -hier -regexp \
    {^.*/tdc_gpx_lidar_ctrl_v2_0/U0/u_status_snapshot/u_tdc_mailbox/domain_request_r_reg.*$}]
set l0_tdc_diag_rsp_src [get_cells -quiet -hier -regexp \
    {^.*/tdc_gpx_lidar_ctrl_v2_0/U0/u_status_snapshot/u_tdc_mailbox/domain_response_r_reg.*$}]
set l0_tdc_diag_rsp_dst [get_cells -quiet -hier -regexp \
    {^.*/tdc_gpx_lidar_ctrl_v2_0/U0/u_status_snapshot/u_tdc_mailbox/source_response_r_reg.*$}]
...
set_max_delay 6.667 -datapath_only \
    -from [get_clocks -quiet -of_objects \
        [get_pins -quiet design_1_lidar_ctrl_v2_i/proc_clk_wiz/inst/mmcm_adv_inst/CLKOUT0]] \
