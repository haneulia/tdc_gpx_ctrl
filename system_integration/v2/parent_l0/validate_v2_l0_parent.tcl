...
if {[llength $argv] != 2} {
    error {Usage: validate_v2_l0_parent.tcl OUTPUT_ROOT OUTPUT_WIDTH}
}
...
set project_path [file join $output_root project_4_lidar_v2_l0.xpr]
set bd_path [file join $output_root project_4_lidar_v2_l0.srcs sources_1 bd \
...
l0_expect_equal project_top [get_property TOP [current_fileset]] \
    design_1_lidar_ctrl_v2_wrapper
l0_expect_count only_v2_bd [get_files -quiet -filter {FILE_TYPE == "Block Designs"}] 1

set ps7 [get_bd_cells processing_system7_0]
set lidar [get_bd_cells tdc_gpx_lidar_ctrl_v2_0]
...
foreach {property expected} [list \
    ...
    l0_expect_equal "v2 $property" [get_property $property $lidar] $expected
}
...
l0_expect_same_intf_net fall_stream \
    tdc_gpx_lidar_ctrl_v2_0/m_axis_fall axi_vdma_fall/S_AXIS_S2MM
...
validate_bd_design
puts "LIDAR_V2_L0_PARENT_VALIDATE_PASS output=$output_root width=$output_width"
close_project
exit 0
