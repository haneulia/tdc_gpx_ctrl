...
proc init_gui { IPINST } {
  ...
  ipgui::add_static_text $IPINST -name "clock_help" -parent ${Clock_Contract} -text {ASYNC allows either Processing/TDC frequency order. SYNC requires equal values and the same physical clock net. K0 routine sign-off covers 150/200 and 200/150 MHz.}
