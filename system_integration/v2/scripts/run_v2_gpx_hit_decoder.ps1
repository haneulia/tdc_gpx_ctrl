...
$Scenario = [ordered]@{
    ...
    return_contract = "B6 does not count Returns; every valid I-Mode word passes to B7"
    overflow_contract = "B7 owns eighth-and-later Return overflow diagnostics"
    input_pipeline = "one registered raw-event stage"
    output_pipeline = "one held typed-event register"
