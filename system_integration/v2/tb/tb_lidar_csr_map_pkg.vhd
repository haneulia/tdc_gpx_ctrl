-- ============================================================================
-- 테스트 자산 목적: 32 CTL/32 STAT CSR bit map과 기본값 변환 함수를 검증한다.
-- 핵심 검증 계약: CSR word와 typed record 사이 pack/unpack이 bit 단위로 일치한다.
-- 관련 RTL: lidar_csr_map_pkg, lidar_config_types_pkg, lidar_config_reference_pkg.
-- 실행 회귀: scripts/run_v2_unified_csr.ps1
-- 유지보수 주의: 주소나 bit를 바꾸면 register 문서와 이 round-trip 벡터를 같이 바꾼다.
-- ============================================================================
library ieee;
