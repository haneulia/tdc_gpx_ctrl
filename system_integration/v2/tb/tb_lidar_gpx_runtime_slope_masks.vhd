-- ============================================================================
-- 테스트 자산 목적: build topology 안에서 runtime Rise/Fall mask가 안전하게 적용되는지 검증한다.
-- 핵심 검증 계약: one-Chip dual-edge, four-Chip dual-edge와 inactive slope drop 진단이다.
-- 관련 RTL: lidar_gpx_hit_decoder, lidar_gpx_cell_collector.
-- 실행 회귀: scripts/run_v2_gpx_frame_lane_assembler.ps1
-- 유지보수 주의: runtime mask는 build mask의 부분집합이라는 assertion을 제거하지 않는다.
-- ============================================================================
library ieee;
