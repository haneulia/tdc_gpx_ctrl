-- ============================================================================
-- 테스트 자산 목적: 한 GPX Chip의 IFIFO1/2 drain과 typed B5 결과 생성을 검증한다.
-- 핵심 검증 계약: 28-bit 순서, EF 기반 drain, timeout, cap/purge와 backpressure 보존이다.
-- 관련 RTL: lidar_gpx_acquisition_lane, tdc_gpx_chip_run, GPX bus engine.
-- 실행 회귀: scripts/run_v2_gpx_acquisition_lane.ps1
-- 유지보수 주의: IFIFO 종료 정책 변경 시 정상 drain과 cap/timeout을 분리해 검증한다.
-- ============================================================================
library ieee;
