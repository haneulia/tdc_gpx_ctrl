-- ============================================================================
-- 테스트 자산 목적: Shot 요청 이후 실제 laser와 TDC 제어 시퀀스를 검증한다.
-- 핵심 검증 계약: fire/fire_done/start_tdc/stop_tdc, timeout과 simulation 상호배제이다.
-- 관련 RTL: laser_executor.
-- 실행 회귀: scripts/run_v2_laser_executor.ps1
-- 유지보수 주의: fire_done 저지연 경로를 바꾸면 cycle-accurate latency assertion을 유지한다.
-- ============================================================================
library ieee;
