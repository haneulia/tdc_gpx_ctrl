-- ============================================================================
-- 테스트 자산 목적: COMMIT 시 순차 검증, 시간 변환, 양자화와 오류 코드를 검증한다.
-- 핵심 검증 계약: 유효 후보만 Derived 설정이 되고 실패 후보는 Active로 진행하지 않는다.
-- 관련 RTL: lidar_commit_calculator와 설정/기준 산식 package.
-- 실행 회귀: scripts/run_v2_commit_calculator.ps1
-- 유지보수 주의: 물리 단위나 범위를 바꾸면 정상/경계/초과 벡터를 모두 추가한다.
-- ============================================================================
library ieee;
