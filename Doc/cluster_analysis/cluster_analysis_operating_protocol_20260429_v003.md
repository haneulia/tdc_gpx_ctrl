...
- C01 v003는 사용자 검토 내용을 반영해 작성되었다.
...
## 10. v003 -> v004 반영 위치 기록

이 절은 운영 프로토콜 v003 이후 사용자 피드백이 v004 어디에 반영되었는지 추적하기 위한 forward trace이다.

### 변경 원인

사용자는 PPT에 실제 Timing Diagram이 부족해 이해와 소통에 문제가 있다고 피드백했다. 앞으로 다음 버전을 제시할 때는 Timing Diagram을 필수로 작성하고, 이 기준을 운영 규칙에 추가하도록 요청했다.

### v004 반영 위치

다음 파일에 반영되었다.

- `Doc/cluster_analysis/cluster_analysis_operating_protocol_20260429_v004.md`

반영 위치:

| v003에서 보완 필요했던 내용 | v004 반영 위치 | 판단 변화 |
|---|---|---|
| PPT Timing Diagram 필수 규칙 부재 | v004 `## 5. 산출물 버전 규칙`의 `PPT Timing Diagram 필수 규칙` | 시간 순서가 핵심인 Cluster PPT에는 Timing Diagram slide를 반드시 포함 |
| 사용자 피드백 시간순 기록 필요 | v004 `## 8. 시간순 대화 기록`의 `2026-04-29 PPT Timing Diagram 필수 규칙 추가` | 새 운영 규칙 추가 경위를 기록 |

즉시 적용 대상:

- `Doc/cluster_analysis/C01_GPX_Bus_Read/C01_GPX_Bus_Read_20260429_v004.pptx`
