...
## 18. v006 -> v007 반영 위치 기록

### 사용자 추가 피드백

사용자는 정상 READ sequence 문제에 대해, 200 MHz 이하이면서 125 MHz 이상인 clock 중 정수로 떨어지는 후보 clock과 그 비교표도 추가해 달라고 요청했다.

### v007 반영 위치

| 사용자 피드백 | v007 반영 위치 | 반영 내용 |
|---|---|---|
| 125~200 MHz 사이 정수 후보 clock 비교 필요 | C01 v007 `### 125 MHz 이상 200 MHz 이하 정수 Tclk 후보 비교` | `Tclk=5/6/7/8 ns` 후보를 200/166.667/142.857/125 MHz로 정의 |
| 후보별 정상 READ timing 비교 필요 | C01 v007 후보 비교 table | 각 후보의 최단 정상 `div,ticks`, `RDN low->capture`, `tick0->capture`, `tPW-RL`, burst period/rate 비교 |
| PPT에도 비교표 추가 필요 | C01 v007 PPT Slide 3 | 정상 READ 200/250 MHz 비교와 함께 125~200 MHz 후보 clock table 추가 |

### v007 산출물

- `Doc/cluster_analysis/C01_GPX_Bus_Read/C01_GPX_Bus_Read_20260429_v007.md`
- `Doc/cluster_analysis/C01_GPX_Bus_Read/C01_GPX_Bus_Read_20260429_v007.pptx`
