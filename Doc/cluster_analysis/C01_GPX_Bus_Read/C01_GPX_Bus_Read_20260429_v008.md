...
### Latency / Throughput / Pipeline 분석
...
## 18. v008 -> v009 반영 위치 기록

변경 시각: `2026-04-29 13:28:39 +09:00`

### 사용자 추가 피드백

사용자는 II(Initiation Interval) 분석을 추가해 달라고 요청했다. 또한 운영 규칙에 문서 수정 시간을 포함하고, 매 결과마다 latency, throughput, pipeline, II를 분석하며 Timing Diagram 또는 Timing Block Diagram으로 Markdown과 PPT에서 이해할 수 있게 규칙으로 반영해 달라고 요청했다.

### v009 반영 위치

| 사용자 피드백 | v009 반영 위치 | 반영 내용 |
|---|---|---|
| II 분석 추가 | C01 v009 `#### II(Initiation Interval) 분석` | Burst READ II와 non-burst READ II 공식 및 후보 clock별 table 추가 |
| 문서 수정 시간 포함 | C01 v009 header | `최종 수정 시간: 2026-04-29 13:28:39 +09:00` 추가 |
| 운영 규칙 반영 | 운영 프로토콜 v005 | `Latency / Throughput / Pipeline / II 필수 분석 규칙`, `문서 수정 시간 기록 규칙` 추가 |
| PPT에도 반영 | C01 v009 PPT Slide 10 | Latency/Throughput/Pipeline/II 전용 slide로 갱신 |

### v009 산출물

- `Doc/cluster_analysis/C01_GPX_Bus_Read/C01_GPX_Bus_Read_20260429_v009.md`
- `Doc/cluster_analysis/C01_GPX_Bus_Read/C01_GPX_Bus_Read_20260429_v009.pptx`
