# C02_Chip_Acquisition Code Fix Plan v003

문서 버전: `v003`  
작성일: `2026-04-30`  
최종 수정 시간: `2026-04-30 14:08:51 +09:00`  
작성 목적: `C02_Chip_Acquisition_260430133832_Code_Fix_Plan_Review_v001.md`의 사용자 검토 의견 8건과 `C02_Chip_Acquisition_260430140851_Code_Fix_Plan_Review_v002.md`의 사용자 검토 의견 2건을 반영하여, C02 RTL/TB/문서 보완 계획을 기능 검증 경계, drain pipeline 구조 비교, `tS-EF` timing 기준점, pipeline/II 분석, risk-control, 승인 matrix 중심으로 재작성한다.
...
| `C02_Chip_Acquisition_260430133832_Code_Fix_Plan_Review_v001.md` | Plan v002에 반영되었고 본 Plan v003에서도 유지하는 사용자 검토 의견 R-C02-P001-01~08. |
| `C02_Chip_Acquisition_260430140851_Code_Fix_Plan_Review_v002.md` | 본 Plan v003에 반영할 사용자 검토 의견 R-C02-P002-01~02. |
...
| 항목 | 내용 |
|---|---|
| 이전 계획 | `C02_Chip_Acquisition_260430133832_Code_Fix_Plan_v002.md` |
| 사용자 Review | `C02_Chip_Acquisition_260430133832_Code_Fix_Plan_Review_v001.md`, `C02_Chip_Acquisition_260430140851_Code_Fix_Plan_Review_v002.md` |
| 본 계획 | `C02_Chip_Acquisition_260430140851_Code_Fix_Plan_v003.md` |
| 다음 단계 | 사용자 승인 후 RTL/TB/script/doc 보완 진행 |
| 판단 변화 | v002의 10개 검증 경계, 9개 risk, 12개 approval matrix를 유지하면서, 목표 B에는 현재/개선 drain pipeline 구조 비교와 `ST_DRAIN_BURST` raw FIFO 합류 정정을 추가했고, 목표 C에는 `tS-EF` 기준점을 `RDN falling edge`와 capture/response 기준점으로 분리했다. |
