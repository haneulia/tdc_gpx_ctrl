...
$cases = @(
    ...
    [pscustomobject]@{ Label = "matrix_clk150_equal_shared_sync"; Width = 64; Axis = 150; Tdc = 150; Present = "1111"; Rise = "0011"; Fall = "1100"; MaxStops = 8; MaxHits = 7; Stream = "SYNC"; Implement = $true; ImplStrategy = "TIMING_EXPLORE" },
    [pscustomobject]@{ Label = "matrix_axis150_tdc100_split_async"; Width = 64; Axis = 150; Tdc = 100; Present = "1111"; Rise = "0011"; Fall = "1100"; MaxStops = 8; MaxHits = 7; Stream = "ASYNC"; Implement = $true; ImplStrategy = "TIMING_EXPLORE" },
    ...
    [pscustomobject]@{ Label = "matrix_w128_axis50_tdc200_split_async"; Width = 128; Axis = 50; Tdc = 200; Present = "1111"; Rise = "0011"; Fall = "1100"; MaxStops = 8; MaxHits = 7; Stream = "ASYNC"; Implement = $true; ImplStrategy = "TIMING_EXPLORE" },
    [pscustomobject]@{ Label = "matrix_w32_axis200_tdc50_split_async"; Width = 32; Axis = 200; Tdc = 50; Present = "1111"; Rise = "0011"; Fall = "1100"; MaxStops = 8; MaxHits = 7; Stream = "ASYNC"; Implement = $true; ImplStrategy = "TIMING_EXPLORE" },
