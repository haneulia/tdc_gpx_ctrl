...
begin
    ...
    ---------------------------------------------------------------------------
    -- Slope demux (REGISTERED) -- the ONLY process in this module
    ...
    begin
        if rising_edge(i_clk) then
            if i_rst_n = '0' then
                ...
                -- tdata and tuser: no reset needed (valid qualifies)
            else
                for i in 0 to c_N_CHIPS-1 loop
                    s_rise_valid_r(i) <= i_evt_sk_tvalid(i)
                        and (i_evt_sk_tuser(i)(0) or i_evt_sk_tuser(i)(7));
                    s_fall_valid_r(i) <= i_evt_sk_tvalid(i)
                        and (not i_evt_sk_tuser(i)(0) or i_evt_sk_tuser(i)(7));
